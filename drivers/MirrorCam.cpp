...
extern "C" __declspec(dllexport) HRESULT DllGetClassObject(
    ...
    // Full COM class factory implementation goes here.
    // This file provides the registration and IPC scaffolding.
    // The complete BaseClasses DirectShow implementation is in MirrorCam_Filter.cpp
    if (!ppv) return E_POINTER;
    *ppv = nullptr;
    return CLASS_E_CLASSNOTAVAILABLE; // placeholder until BaseClasses linked
}
